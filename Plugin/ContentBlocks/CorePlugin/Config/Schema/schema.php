 ...
 * UsersSchema class
 *
 * Schema information for the Users plugin.
 *
 * @copyright	 Copyright 2010-2012, Radar Hill Technology Inc. (http://radarhill.com)
 * @link		 http://api.pyramidcms.com/docs/classContentBlocksSchema.html
 * @package		 Cms.Plugin.ContentBlocks.Config.Schema 
 * @since		 Pyramid CMS v 1.0
 */
class ContentBlocksSchema extends CmsSchema {

	public $name = 'ContentBlocks';
