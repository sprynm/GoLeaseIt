...
const blockedChecks = [
  ...
  {
    id: "deprecated-surface-section-classes",
    message: "Deprecated section surface class detected. Use `u-surface-base` / `u-surface-muted`.",
    pattern: /\bsection-(?:white|soft)\b/g,
    include: [/\.(ctp|php|html|js)$/i],
    exclude: [
      /docs[\\/]/i
    ]
  },
